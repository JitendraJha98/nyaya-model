...
Pipeline (docs/ROADMAP.md, Step 8; near-duplicate REMOVAL is the next step,
scripts/06_deduplicate.py):
    ...
    answer length check (80–600 words) ->
...
low quality / leakage / accepted). A 15–20% rejection rate is healthy — it
means the pipeline is filtering garbage.
