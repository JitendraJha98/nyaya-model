...
1. **`NyayaLabs98/nyaya-statute-db`** (dataset) — *already public, needs a card*
   27 acts plus the Constitution as clean JSONL, one row per section, plus the official IPC↔BNS and
...
3. **What is still genuinely differentiated:** the statute DB is 27 acts plus the Constitution with
